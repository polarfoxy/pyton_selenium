...
class unit(unittest.TestCase):
    ...
    def test_unit(self):
        ...
        self.create_contact(wd, firstname="wtwetw", middlename="werwerwer", lastname="erwrwerewr", nickname="hhjhjjj",
    ...
    def create_contact(self, wd, firstname, middlename, lastname, nickname, title, company, home, address, mobile, work,
                       fax, email, email2, email3, homepage, byear, ayear, phone2, address2, notes):
